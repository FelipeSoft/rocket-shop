    ...
    return (
        <div className="flex justify-between">
            ...
            <div className="p-20 w-2/3 h-screen flex flex-col items-center justify-center bg-gray-100">
                <h2 className="text-3xl mb-6 text-gray-800 font-semibold">Cadastro no Rocket Shop!</h2>
                ...
                <div className="mb-6">
                    ...
                    <br />
                    <input
                        className="border-2 border-gray-300 p-2 w-60 rounded-md"
                        type="password"
                        id="password"
                        placeholder="joao12345"
                    />
                ...
                <div className="flex mt-4">
                    <p className="text-xs text-gray-500">Já possui sua conta?</p>
                    <p className="ml-1 text-xs text-blue-500 cursor-pointer">Faça login aqui</p>
                </div>
            </div>
        </div>
    );
